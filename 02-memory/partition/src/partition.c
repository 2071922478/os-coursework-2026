...
static void interactive(Memory *m) {
    ...
    while (1) {
        ...
        switch (c) {
            case 1: printf("Algorithm (0=FF 1=BF 2=WF): "); scanf("%d", &alg); break;
            case 2: {
                char name[MAX_NAME]; int sz;
                printf("name size: "); scanf("%15s %d", name, &sz);
            ...
            case 6: {
                char path[256];
                printf("case file path: "); scanf("%255s", path);
                Memory tmp = *m;
